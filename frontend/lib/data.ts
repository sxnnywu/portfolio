...
export const roles: Role[] = [
  {
    ...
    bullets: [
      ...
      "Grew first-time downloads {147%} in 90 days through {App Store Optimization} and keyword iteration",
      "Drove {2000+ downloads}, {520k+ organic views}, and industry invitations to {Toronto Fashion Week} by running a {build-in-public} content strategy in the fashion niche across Instagram, TikTok, and LinkedIn",
      "Converted waitlist into {862 subscribers} at a {60%} open rate by writing newsletters on an in-house platform",
      "Cut manual marketing production time {80%} by building {3 internal LLM agent workflows}, with human review gates, to automate newsletter production, content generation, and design-system-to-code sync",
    ],
  },
  {
    title: "Campus Leader",
  ...
  },
  {
    ...
    company: "Sip & Scale",
    summary: "Drove {1000+ launch week signups} and {$1200+ in ticket sales}.",
    dates: "Jun 2026 - Present",
    location: "Waterloo",
    tags: ["growth", "ops"],
    bullets: [
      "Drove {1000+ launch week signups} and converted overflow demand into {$1200+ in ticket sales}",
      "Reached {100k+ people} on {zero paid spend} through {creator seeding}, recruiting 8 creators (34k+ following)",
      "Closed {7 sponsorships} with {zero cold outreach} by sourcing entirely through warm introductions",
      "Staffed both events at {zero cost} by converting waitlist into volunteers in exchange for entry",
    ],
  },
  {
    title: "Growth Contractor",
    company: "Stan, Polarity, GenTube, Jobright",
    dates: "Feb 2026 - Present",
    location: "Remote",
    tags: ["growth"],
    summary: "Reached {1.2M+ impressions} through {multi-channel distribution} for four startups.",
    bullets: ["Reached {1.2M+ impressions} by running {multi-channel distribution} on a weekly editorial cadence across LinkedIn, Instagram, TikTok, X, Reddit, and Pinterest, adapting format and voice to each platform", "Ran {UGC} program on GenTube's company account and {ghost-wrote} the founder account as thought leadership", "Drove {130k impressions} on Polarity's top-performing post by repositioning content based on performance data"],
  },
  {
  ...
  },
  {
    ...
    summary: "Built a community reaching {8M+ girls} across {26 countries}.",
    dates: "Jun 2024 - Dec 2025",
    location: "Toronto",
    tags: ["growth", "ops"],
    bullets: [
      "Reached {8M+ girls} across {26 countries} through {audience-first positioning}, leading content with the feminist movement rather than the organization itself and scaling into new markets organically",
      "Grew social channels to {30M+ views} and {11k+ followers} by producing and distributing every asset in-house",
      "Scaled operations to {300 volunteers} by structuring tiered departments with defined roles and onboarding",
